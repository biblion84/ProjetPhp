	...
	*/
	public function run() {
		...
		if ($_POST["responseSurvey$i"]){
			$value = preg_replace("/[^a-zA-Z0-9 ]/", "", $_POST["responseSurvey$i"]); //remplace les carracteres spéciaux dans les réponses, ce qui fausserait les réponses (avec l'explode et htmlspecialchar ça faisait un bug)
