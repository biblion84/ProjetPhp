...
class Database {
	...
	*
	* @param string $comm Commentaire
	* @param string $survId ID du sondage
	...
	*/
	 ...
	 * Supprime un sondage
	 *
	 * @param string $survId ID du sondage à supprimer
	...
	*/
	...
	/**
	* Charge l'ensemble des commentaires d'un sondage.
	*
